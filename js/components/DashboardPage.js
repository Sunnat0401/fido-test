        ...
        ${DEMO_TEAM.map(
          ...
          <div class="workload-member">
            <div class="workload-avatar-wrap">
              <img src="${member.avatar}" class="workload-avatar" alt="${
            member.name
          }" />
            ...
            <div class="workload-info">
              ...
              <span class="workload-status badge-${member.status.toLowerCase()}">${
            member.status
          }</span>
            </div>
          </div>
        ...
        ${DEMO_PROJECTS.map(
          ...
          <div class="project-item card">
            <div class="project-info">
              ...
              <span class="project-priority badge badge-${project.priority.toLowerCase()}">${
            project.priority
          }</span>
            </div>
            <div class="project-meta">
              ...
              <span class="project-assignees">${project.assignees
                .map(
                  (a) =>
                    `<img src="${a.avatar}" class="project-assignee-avatar" alt="${a.name}" title="${a.name}"/>`
                )
                .join("")}</span>
            </div>
          </div>
