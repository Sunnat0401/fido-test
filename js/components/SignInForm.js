  ...
  function render() {
    ...
    side.innerHTML = `
        <div class="woorkroom-sing-in-side">
          <img class="woorkroom-sing-in-side-logo" src="assets/logo.jpg" alt="Woorkroom" class="woorkroom-logo">
        ...
        <img class="woorkroom-sing-in-side-pircture" src="assets/sign-in.jpg" alt="Workboard" class="woorkroom-workboard">
      `;
