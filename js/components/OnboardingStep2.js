...
// function SelectInput({ label, value, options, onChange, name }) {
...
//   select.style = "font-size:17px;border-radius:11px;border:1.5px solid #e3e8ef;padding:12px 16px;";
//   options.forEach(opt => {
...
// function RadioGroup({ label, value, options, onChange, name }) {
//   const group = document.createElement("div");
//   group.className = "input-group";
//   const labelEl = document.createElement("label");
//   labelEl.className = "input-label";
...
//   radioRow.style = "display:flex;gap:24px;align-items:center;margin-top:6px;";
//   options.forEach(opt => {
//     const radioLabel = document.createElement("label");
//     radioLabel.style = "font-size:16px;display:flex;align-items:center;gap:6px;cursor:pointer;";
//     const radio = document.createElement("input");
//     radio.type = "radio";
//     radio.name = name;
//     radio.value = opt.value;
//     radio.checked = value === opt.value;
//     radio.onclick = () => onChange(opt.value);
//     radioLabel.appendChild(radio);
//     radioLabel.appendChild(document.createTextNode(opt.label));
//     radioRow.appendChild(radioLabel);
//   });
//   group.appendChild(radioRow);
//   return group;
// }
...
//   side.appendChild(Stepper({ step: 2 }));
