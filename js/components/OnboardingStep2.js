...
export function renderOnboardingStep2(container) {
  ...
  shell.appendChild(
    SidePanel({ step: 2, totalSteps: 4, title: "Get started" })
  );
  ...
  ["Yes", "No"].forEach((v, idx) => {
    ...
    radioLabelOpt.style =
      "font-size:16px;display:flex;align-items:center;gap:6px;cursor:pointer;margin-right:18px;";
